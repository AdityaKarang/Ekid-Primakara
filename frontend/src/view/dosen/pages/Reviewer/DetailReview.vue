      ...
      <v-dialog v-model="confirmasi" max-width="290">
        <v-card>
          ...
          <v-card-actions>
            ...
            <v-btn color="green darken-1" text @click="onSaveData()">
              Simpan
            </v-btn>
          </v-card-actions>
        </v-card>
            ...
            <v-form>
              <table>
                <tbody>
                  ...
                  <tr>
                    <td><h6>Mahasiswa 1</h6></td>
                    <td>
                      <h6>: {{ dataLaporan.mahasiswa_1 }}</h6>
                    </td>
                  </tr>
                  <tr>
                    <td><h6>Mahasiswa 2</h6></td>
                    <td>
                      <h6>: {{ dataLaporan.mahasiswa_2 }}</h6>
                    </td>
                  </tr>
      ...
      dataNilai: [
        {
          ...
          indikators: [
            {
              name: "Ketajaman Perumusan Masalah ",
        ...
        },
        {
          ...
          indikators: [
            ...
            },
            {
              ...
              prefix_radio: "pembangunan Kelembagaan",
              bobot: "20",
              nilai: 0,
            },
            {
              name: "Luaran Sesuai IKUP  ",
              prefix_radio: "Luaran Sesuai IKUP ",
              bobot: "20",
              nilai: 0,
            },
          ],
        },
        {
          ...
          indikators: [
            {
              name: "Relevansi",
              prefix_radio: "Relevansi ",
              bobot: "15",
              nilai: 0,
            },
            {
              name: "Kemuktahiran  ",
              prefix_radio: "Kemuktahiran  ",
              bobot: "15",
              nilai: 0,
            },
            {
              name: "Penyusunan Daftar Pustaka  ",
              prefix_radio: "Penyusunan Daftar Pustaka ",
              bobot: "15",
              nilai: 0,
            },
          ],
          ...
          indikators: [
            {
              ...
              prefix_radio: "Ketepatan Metode Yang Digunakans ",
              bobot: "30",
              nilai: 0,
            },
          ],
          ...
          indikators: [
            {
              ...
              prefix_radio: "Kesesuaian Jadwal ",
              bobot: "10",
              nilai: 0,
            },
            {
              ...
              prefix_radio:
                "Kesesuaian Keahlian Personalia dan Kewajaran Biaya ",
              bobot: "10",
              nilai: 0,
            },
          ],
...
fetchPenilaianProposal() {
  ...
  //   },
    ...
    onSaveData() {
  const dataPenilaian = {
    kriteria_penilaian_id: 1, // Replace with the appropriate value
    validasi_penilaian_id: 1, // Replace with the appropriate value
    user_id: 1, // Replace with the appropriate value
