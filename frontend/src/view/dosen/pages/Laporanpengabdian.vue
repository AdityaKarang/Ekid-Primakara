<template>
  <div>
    <v-row justify="center">
      <v-dialog v-model="dialogPublikasi" persistent max-width="800px">
        <v-card>
              ...
              <v-row>
                <v-col cols="12">
                  <v-select
                    ...
                    :disabled="checkDisable(formPublikasi.status)"
                  >
                  </v-select>
                </v-col>
                ...
                <template v-if="onCheckSelectFormStatus('jurnal')">
                  ...
                  <v-col cols="12">
                    <v-file-input v-model="formPublikasi.jurnal.file_jurnal" :disabled="checkDisable(formPublikasi.status)" label="Upload Jurnal"
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn  v-if="!checkDisable(formPublikasi  .status)" color="blue darken-1" text @click=" savePublikasi()"
              >Submit</v-btn
            >
          </v-card-actions>
        </v-card>
        ...
        <v-expansion-panels v-if="formBerkas.penilaian1 && checkDisable(formBerkas.status)">
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              ...
              <v-row>
                <v-col cols="12">
                  <v-textarea name="catatan" label="catatan" outlined v-model="catatan_kemajuan_1" disabled
                    value=""></v-textarea>
                </v-col>
              </v-row>
            </v-expansion-panel-content>
        ...
        <v-expansion-panels v-if="formBerkas.penilaian2 && checkDisable(formBerkas.status)">
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              ...
              <v-row>
                <v-col cols="12">
                  <v-textarea name="catatan" label="catatan" outlined v-model="catatan_kemajuan_2" disabled
                    value=""></v-textarea>
                </v-col>
              </v-row>
            </v-expansion-panel-content>
        ...
        <v-expansion-panels v-if="formBerkas.penilaian1 && checkDisable(formBerkas.status)">
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              ...
              <v-row>
                <v-col cols="12">
                  <v-textarea name="catatan" label="catatan" outlined v-model="catatan_akhir_1" disabled
                    value=""></v-textarea>
                </v-col>
              </v-row>
            </v-expansion-panel-content>
        ...
        <v-expansion-panels v-if="formBerkas.penilaian2 && checkDisable(formBerkas.status)">
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              ...
              <v-row>
                <v-col cols="12">
                  <v-textarea name="catatan" label="catatan" outlined v-model="catatan_akhir_2" disabled
                    value=""></v-textarea>
                </v-col>
              </v-row>
            </v-expansion-panel-content>
    ...
    <CustomCard
      ...
      deskripsi="List Daftar pengabdian Yang Telah Di Inputkan"
      :headers="headers"
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch(SET_BREADCRUMB, [{ title: "Laporan Pengabdian" }]);
  },
  methods: {
    fetchData() {
      // Fetch reviewer data
      ...
      const nilaiPromise = axios.get('http://localhost:8000/api/get-akhir-kemajuan');
      ...
      Promise.all([reviewerPromise, nilaiPromise])
        ...
        this.contentTables = nilai.data
          ...
          .map((bf, index) => {
            ...
            let catatan_kemajuan_1 = nilaikemajuan_reviewer_1.length > 0 ? nilaikemajuan_reviewer_1[0].catatan : ""
            let valuekemajuan_reviewer_2 = nilaikemajuan_reviewer_2.length > 0 ? nilaikemajuan_reviewer_2[0].valuepenilaian : [];
            let catatan_kemajuan_2 = nilaikemajuan_reviewer_2.length > 0 ? nilaikemajuan_reviewer_2[0].catatan : ""
            ...
            let catatan_akhir_1 = nilaiakhir_reviewer_1.length > 0 ? nilaiakhir_reviewer_1[0].catatan : ""
            let valueakhir_reviewer_2 = nilaiakhir_reviewer_2.length > 0 ? nilaiakhir_reviewer_2[0].valuepenilaian : [];
            let catatan_akhir_2 = nilaiakhir_reviewer_2.length > 0 ? nilaiakhir_reviewer_2[0].catatan : ""
            ...
            return {
              ...
              kemajuan: {
                ...
                penilaian1: {
                  ...
                  catatan_kemajuan_1: catatan_kemajuan_1,
                },
                penilaian2: {
                  header: [
                    { text: "No", value: "no", width: "20px" },
                  ...
                  catatan_kemajuan_2: catatan_kemajuan_2,
                },
              },
              akhir: {
                ...
                penilaian1: {
                  ...
                  catatan_akhir_1: catatan_akhir_1,
                },
                penilaian2: {
                  header: [
                    { text: "No", value: "no", width: "20px" },
                  ...
                  catatan_akhir_2: catatan_akhir_2,
                },
              },
              publikasi: {
    ...
    Kemajuan(item) {
      ...
      this.catatan_kemajuan_1 = item.kemajuan.penilaian.catatan_kemajuan_1;
      this.catatan_kemajuan_2 = item.kemajuan.penilaian.catatan_kemajuan_2;
    },
    saveKemajuan() {

      const formData = new FormData();
      formData.append("pengabdian_id", this.itemID);
      ...
      axios
        .post("http://localhost:8000/api/laporankemajuan-pengabdian", formData, {
          headers: {
    ...
    Akhir(item) {
      ...
      this.catatan_akhir_1 = item.akhir.penilaian.catatan_akhir_1;
      this.catatan_akhir_2 = item.akhir.penilaian.catatan_akhir_2;
    },
    saveAkhir() {
      ...
      // Lanjutkan dengan permintaan POST yang sudah diperbarui
      axios
        .post("http://localhost:8000/api/laporanakhir-pengabdian", formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
