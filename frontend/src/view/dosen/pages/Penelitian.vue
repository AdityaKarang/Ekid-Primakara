      ...
      <v-card class="">
        ...
        <v-card-text>
          <v-form>
            ...
            <b-button type="button" variant="primary" @click="confirmasi = true"
              :disabled="!isFormComplete">Submit</b-button>
          </v-form>
        </v-card-text>
      </v-card>
    </v-dialog>
    <CustomCard title="List of Proposal Penelitian" deskripsi="List of Proposal Penelitian That Have Been Inputted"
      :headers="headers" :loading="loading" :contentTable="contentTables" :isTopAction="false" :isEdit="false"
      :isDelete="false" @detailItem="detailData">
...
export default {
  ...
  methods: {
    ...
    onSave() {
      ...
      axios
        .post("http://localhost:8000/api/penelitian", formData, {
          headers: {
...

{
  ...
  status: "Rejected",
  keterangan: "nilai kurang memenuhi",
}, -->
