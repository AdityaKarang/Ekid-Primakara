  ...
  <div>
    <b-tabs content-class="mt-3">
      <b-tab title="Proposal" active>
        <b-card header="Laporan Proposal">
          ...
          <DataTableCustom
            ...
            @editData="editDataProposal"
            @detailData="editDataProposal"
          />
        </b-card>
      </b-tab>
      ...
      <b-tab title="Publikasi">
        <b-card header="Laporan Akhir">
          ...
          <DataTableCustom
            ...
            :headers="headers"
            :contentTable="contentTables"
            @editData="editDataPublikasi"
            @detailData="editDataPublikasi"
          />
        </b-card>
      </b-tab>
    </b-tabs>
...
import DataTableCustom from "@/view/lppm/content/DataTableCustom";
...
export default {
  ...
  methods: {
    ...
    editDataProposal(item) {
      console.log(item);
      this.$router.push({
        path: "/lppm/input-pengabdian",
        query: { tab: "proposal" },
      });
    },
