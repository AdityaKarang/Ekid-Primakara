<template>
  <b-card>
    <div class="mt-3">
          ...
          <v-card-text>
            <v-form>
              <v-row>
                <v-col md="6">
                  <v-text-field
                    v-model="form.tingkatilmiah"
                    label="Tingkat Ilmiah"
                    required
                  ></v-text-field>
                </v-col>
              </v-row>
      ...
      <CustomCard
        title="Daftar Tingkat Ilmiah"
        deskripsi="List Daftar Tingkat Ilmiah Yang Telah Di Inputkan"
        :headers="headers"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: "No", value: "no" },
        { text: "Tingkat Ilmiah", value: "tingkatilmiah" },
        { text: "Actions", value: "detail" },
      ],
      contentTables: [
        {
          no: "1",
          tingkatilmiah: "Regional",
        },

        {
          no: "2",
          tingkatilmiah: "Nasional",
        },

        {
          no: "3",
          tingkatilmiah: "Internasional",
        },
      ],
    };
  },
