<template>
  <b-card>
    <div class="mt-3">
      ...
      <CustomCard
        title="Daftar Jenis Hak Kekayaan Intelektual (HKI)"
        deskripsi="List Daftar Jenis HKI Yang Telah Di Inputkan"
        :headers="headers"
...
export default {
  ...
  data() {
    return {
      ...
      contentTables: [
        ...
        {
          no: "4",
          jenishki: "Desain Produk Industri",
        },
      ],
    };
  },
  methods: {
    ...
    editData(item) {
      console.log("test");
      this.showAdd = true;
      this.form.jenishki = item.jenishki;
    },
    deleteData(item) {
