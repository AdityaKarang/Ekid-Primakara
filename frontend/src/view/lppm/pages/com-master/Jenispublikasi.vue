<template>
  <b-card>
    <div class="mt-3">
      ...
      <CustomCard
        title="Daftar Jenis Publikasi"
        deskripsi="List Daftar Jenis Publikasi Yang Telah Di Inputkan"
        :headers="headers"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: "No", value: "no" },
        { text: "Jenis Publikasi", value: "jenispublikasi" },
