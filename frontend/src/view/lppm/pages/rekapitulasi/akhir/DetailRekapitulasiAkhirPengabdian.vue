            ...
            <tbody>
              ...
              <tr class="mt-2">
                ...
                <td>
                  <h5>
                    <a
                      v-if="dataLaporan.laporanakhir.laporan_akhir !== ''"
                      :href="getUrl(dataLaporan.laporanakhir.laporan_akhir)"
                      target="__blank"
                    >
                      :
...
export default {
  ...
  methods: {
    ...
    getDataNilai(index) {
      ...
      const penelitianPromise = axios.get('http://localhost:8000/api/show-value-akhir/' + item.aksi);
