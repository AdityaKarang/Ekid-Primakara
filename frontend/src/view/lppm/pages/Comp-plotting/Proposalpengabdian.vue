<template>
  <div>
    ...
    <CustomCard title="Daftar Proposal Pengabdian" deskripsi="List Daftar Proposal Pengabdian Yang Telah Di Inputkan"
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      const pengabdianPromise = axios.get('http://localhost:8000/api/get-value-pengabdian');
    ...
    uploadContract(item) {
      ...
      axios
        .post("http://localhost:8000/api/kontrak-pengabdian/" + this.id, formData, {
          headers: {
    ...
    revisi(item) {
      ...
      axios
        .post("http://localhost:8000/api/update-status-pengabdian/" + this.id, formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
