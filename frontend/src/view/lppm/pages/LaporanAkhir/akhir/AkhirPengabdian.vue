<template>
  <div>
    ...
    <CustomCard title="Daftar Akhri Pengabdian" deskripsi="List Daftar Akhir Pengabdian Yang Telah Di Inputkan"
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      const pengabdianPromise = axios.get('http://localhost:8000/api/get-value-akhir');
    ...
    approve(item) {
      axios
        .get('http://localhost:8000/api/laporanakhirPengabdian/' + this.id)
        .then((response) => {
